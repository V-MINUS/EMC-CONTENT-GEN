...
const EnhancedContentForm: React.FC<EnhancedContentFormProps> = ({
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    const enhancedFormValues: Record<string, string> = {
      ...formValues,
      tone: selectedTone,
    ...
    // Only add brandVoice if it exists to avoid TypeScript errors
    if (selectedTone === 'brandVoice' && customBrandVoice) {
      enhancedFormValues.brandVoice = customBrandVoice;
    }
            ...
            {selectedTone === 'brandVoice' && (
              <div className="mb-4">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-border bg-background rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary text-black dark:text-white mb-2"
                >
